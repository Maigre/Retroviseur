...
const dict = {
	en: {
		...
		aboutHow: 'Flick the wheel to the left until it locks, then press the shutter.',
	...
	fr: {
		...
		aboutHow: 'Faites glisser la molette vers la gauche jusqu’au blocage, puis appuyez sur le déclencheur.',
